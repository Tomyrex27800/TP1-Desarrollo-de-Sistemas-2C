...
# Reporte 5, cantidad de sedes por región geográfica
...
# Reporte 6, boxplot PBI per cápita 2023 por región (solo países con sede)
...
# Reporte 7, relación PBI per cápita vs cantidad de sedes
